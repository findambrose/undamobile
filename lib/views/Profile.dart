      ...
      builder: (context, snapshot) {
        ...
        if (snapshot.hasData) {
          ...
          userInfo.docs.forEach((element) {
            ...
            profileStatus = element.data()["profileStatus"];
            profileStatus = element.data()["role"];
          });

          if(profileStatus == 'Mechanic'){
            _setUpExtraMechanicInfo();
            return Scaffold(
              ...
              _onItemSelect(int itemSelected, QuerySnapshot snapshot) {
                ...
                switch (itemSelected) {
                  ...
                  case 2:
                    ...
                    snapshot.docs.forEach((element) {
                      if (element.data()["role"] == 'Mechanic') {
                        Navigator.pushNamed(context, '/mecDets');
                      }
                      Navigator.pushNamed(context, '/vOwnerOrders');
                    });
                 ...
                 await Future.delayed(Duration(seconds: 6));
                  return AlertDialog(
                    content: Column(children: [
                      Text("Complete profile setup to start getting orders", style: TextStyle(fontWeight: FontWeight.bold),),
                      SizedBox(height: 10),
                      RaisedButton(child: Text("Complete"),
                    onPressed: (){
